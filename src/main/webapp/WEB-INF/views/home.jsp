...
.box2 a:hover,.box3 a:hover,.box4 a:hover,.icons a:hover{
color:orange;
}
</style>
</head>
...
<!-- Navbar -->
<div class="row navbar-custom m-0">
...
<!-- Center Menu -->
<ul class="center-menu col-lg-6 col-md-4 col-sm-12 justify-content-center text-center">
<li><a href="#">Home</a></li>
...
<!-- Right Profile Icon -->
<div class="profile-icon col-lg-3 col-md-4 col-sm-12 text-lg-end text-center">
